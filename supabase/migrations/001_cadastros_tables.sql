...
-- ============================================
-- 11. CREDORES (update existing or create)
-- ============================================
CREATE TABLE IF NOT EXISTS credores (
    ...
    -- Aba 05 - Informações Complementares
...
-- ============================================
-- ALTER TABLE esferas ENABLE ROW LEVEL SECURITY;
...
DECLARE
    t text;
BEGIN
    FOREACH t IN ARRAY ARRAY['esferas', 'instituicoes', 'orgaos', 'unidades_gestoras', 'setores', 'cargos', 'bancos', 'agencias', 'usuarios', 'exercicios_financeiros', 'credores', 'categorias_documentos', 'subcategorias_documentos']
    LOOP
