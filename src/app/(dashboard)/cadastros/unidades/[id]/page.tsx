...
import { OrdenadoresTab } from '../components/ordenadores-tab';
        ...
        try {
            ...
            if (unidade) {
                ...
                const data = {
                    ...
                    dataPublicacao: unidade.data_publicacao || '',
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="dados" className="space-y-6">
                <TabsList>
                    ...
                    <TabsTrigger value="ordenadores">Ordenadores</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="ordenadores" className="space-y-6">
                    <OrdenadoresTab unidadeGestoraId={params.id as string} />
                </TabsContent>
            </Tabs>
